...
public:
    ...
    // Satır içi aritmetik ve karşılaştırma. Tüm işlemler doğrudan m_kurus
    // (kuruş tam sayısı) üzerinde yapılır, hiçbiri double'a uğramaz — bu
    // yüzden burada yuvarlama hatası oluşamaz. Yuvarlama yapan tek iki işlem
    // operator*(double) ve operator/'dir; ikisi de money.cpp'dedir.
